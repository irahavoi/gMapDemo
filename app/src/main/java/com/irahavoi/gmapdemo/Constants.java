...
/**
 * Created by irahavoi on 2016-01-20.
 */
public class Constants {
    ...
    public static final float BEARING_WEST = 270;
    public static final float TILT_ZERO = 0;
    public static final  int ANIMATION_SLOW  = 5000;
}
